...
${OBJECTDIR}/md5/JointFrame.o: md5/JointFrame.cpp 
	${MKDIR} -p ${OBJECTDIR}/md5
	${RM} $@.d
	$(COMPILE.cc) -g -Wall -std=c++11 `pkg-config --cflags gtkmm-2.4 glibmm-2.4 gtkglextmm-1.2 glew` -MMD -MP -MF $@.d -o ${OBJECTDIR}/md5/JointFrame.o md5/JointFrame.cpp

${OBJECTDIR}/md5/Md5.o: md5/Md5.cpp 
	${MKDIR} -p ${OBJECTDIR}/md5
	${RM} $@.d
	$(COMPILE.cc) -g -Wall -std=c++11 `pkg-config --cflags gtkmm-2.4 glibmm-2.4 gtkglextmm-1.2 glew` -MMD -MP -MF $@.d -o ${OBJECTDIR}/md5/Md5.o md5/Md5.cpp

${OBJECTDIR}/md5/Md5Frame.o: md5/Md5Frame.cpp 
	${MKDIR} -p ${OBJECTDIR}/md5
	${RM} $@.d
	$(COMPILE.cc) -g -Wall -std=c++11 `pkg-config --cflags gtkmm-2.4 glibmm-2.4 gtkglextmm-1.2 glew` -MMD -MP -MF $@.d -o ${OBJECTDIR}/md5/Md5Frame.o md5/Md5Frame.cpp
...
${OBJECTDIR}/md5/Quaternion.o: md5/Quaternion.cpp 
	${MKDIR} -p ${OBJECTDIR}/md5
	${RM} $@.d
	$(COMPILE.cc) -g -Wall -std=c++11 `pkg-config --cflags gtkmm-2.4 glibmm-2.4 gtkglextmm-1.2 glew` -MMD -MP -MF $@.d -o ${OBJECTDIR}/md5/Quaternion.o md5/Quaternion.cpp
